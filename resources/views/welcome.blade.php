...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="bg-white p-10 md:p-16 rounded-3xl shadow-2xl shadow-blue-200/50 mb-12">
                ...
                <div class="mt-16">
                    <div
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900">URL Shortner</h2>

                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                The definitive, **enterprise-grade** system for generating, managing, and tracking
                                short
                                links, complete with **advanced Role-Based Access Control (RBAC)** across multiple
                                companies.
                            </p>
                        </div>
                    </div>
